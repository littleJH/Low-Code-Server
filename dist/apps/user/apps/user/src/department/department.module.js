...
const department_mysql_entity_1 = require("./entities/department.mysql.entity");
    ...
    (0, common_1.Module)({
        ...
        providers: [
            department_service_1.DepartmentService,
            {
                ...
                useFactory: (connection) => connection.getRepository(department_mysql_entity_1.Department),
